...
@positiveflow
Scenario: Tree - Verify that the user is able to navigate to the Terminologies page	
...
@positiveflow
Scenario: Tree - Verify that the user is able to navigate to the Traversals-Illustration page	
Given User is in Tree page	
...
@positiveflow
Scenario: Tree - Verify that the user is able to navigate to the Implementation in Python page	
Given User is in Tree page	
...
@positiveflow
Scenario: Tree - Verify that the user is able to navigate to the Implementation Of BST page	
Given User is in Tree page	
